...
public class ArticuloDtoHome extends ParentPersistenceHome implements PersistenceDtoRemote {
	...
	public String getDtoQuery(SearchDto search) {
		return "select new com.tracker.expense.db.dto.ArticuloDto(a.idarticulo,a.categoria.idcategoria,a.categoria.nombre,a.nombre,a.version) from Articulo a"+addFilters(search)+addOrderFields(search);
	}
